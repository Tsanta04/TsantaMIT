...
///Test d'authentification
	...
	///Sinon
		...
		printf("</style>");
		afficher("contacts.html");
		printf("<div class=\"card-body pt-0\"><div class=\"row\"><div class=\"col-7\"><h2 class=\"lead\"><b>%s</b></h2>",reglage(utilisateur.nom));
		printf("<p class=\"text-muted text-sm\"><b>Id: </b>%s</p>",reglage(utilisateur.id));
		printf("<p class=\"text-muted text-sm\"><b>Mail: </b>%s</p></div><div class=\"col-5 text-center\"><img src=\"../../dist/img/user1-128x128.jpg\" alt=\"user-avatar\" class=\"img-circle img-fluid\"></div></div></div></div></div>",reglage(utilisateur.mail));
