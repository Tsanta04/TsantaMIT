...
<body>
	...
	<main class="profile-page" style='background-color:'grey;''>
		<form id='formulaire' class='w-1/2 absolute border border-1 right-0'
			style='margin-right: 16vw;' action='Developpement.php?mode=<?php echo $_GET["mode"]?>' method='POST'>
            ...
            <?php
				if($_GET["mode"]=="A"){
					...
					echo("Methode: <select id='select_methode' name='methode' class='container' ><option value=4>Newton</option><option value=5>Descente du Gradient</option></select>"
							...
							+"Pas: <input type='number' step='0.0001' placeholder='0.00..' class='container' name='pas' required/>"
					);
				}	
        ...
        if(isset($_SESSION["fonction"])){
            ...
            <div id='ici' class='container absolute right-0 d-flex'
                ...
                <div class='w-50' style='font-size: 2vw;'>
                    ...
                    <ul>
                        <li class='container'>Fonction: ".$_SESSION['fonction']."</p>
                        <li class='container'>Method: ".$_SESSION['methode']."</p>
                        <li class='container'>PointA: ".$_SESSION['pointA']."</p>
                        <li class='container'>PointB: ".$_SESSION['path']."</p>
                        <li class='container'>Nombre iteration: ".$_SESSION['iteration']."</p>
                        <li class='container'>Resultat final: ".$_SESSION['resultat']."</p>
                    </ul>
                </div>
			<div class='w-50'>
